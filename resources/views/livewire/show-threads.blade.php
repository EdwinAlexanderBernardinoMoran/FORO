<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    ...
    <div class="w-64">
        <a href="" class="block w-full py-4 mb-10 bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-600 text-white/90 font-bold text-sx text-center rounded-md">Preguntar</a>
    ...
    <div class="w-full">
        ...
        {{-- Formulario --}}
        <form class="mb-4">
            <input type="text" placeholder="// ..." class="bg-slate-800 border-0 rounded-md w-1/3 p-3 text-white/60 text-xs" wire:model="search">
        </form>
            ...
            <div class="p-4 flex gap-4">
                ...
                <div class="w-full">
                    <h2 class="mb-4 flex items-start justify-between">
                        <a href="{{ route('thread', $thread->id) }}" class="text-xl font-semibold text-white/90">
                            {{ $thread->title }}
                        </a>
